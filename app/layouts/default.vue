  ...
  <client-only>
    <div
      ...
      <div class="md:w-full z-30">
        <div
          class="grid md:w-[1320px] h-full gap-2 grid-cols-1 md:grid-cols-[1fr_3fr] md:grid-rows-1 md:min-w-[1320px] md:mx-auto">
          <Aside class="box h-fit hidden md:block md:sticky md:top-24"></Aside>
    ...
    <div :style="bg2Style" class="bg2 bg-full -z-10 fixed top-0 w-screen h-screen">
